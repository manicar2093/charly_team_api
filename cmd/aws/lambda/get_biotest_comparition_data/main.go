...
import (
	...
	"github.com/manicar2093/charly_team_api/handlers/biotestfilters/biotestcomparitiondatafinder"
...
func main() {
	...
	service := biotestcomparitiondatafinder.NewBiotestComparitionDataFinderImpl(
		biotestRepo,
